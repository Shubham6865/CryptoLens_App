import { Badge, Box, Button, Container, HStack, Img, Radio, RadioGroup, Stat, StatArrow, StatHelpText, StatLabel, StatNumber, Text, VStack } from "@chakra-ui/react"
...
const CoinDetails = () => {
  ...
  const btns = ["24h", "2d", "7d", "14d", "30d", "60d", "200d", "365d", "max"];
